...
class Application(tornado.web.Application):
    def __init__(self):
        ...
        handlers = [
            ...
            (r"/client/local/recognize", LocalAudioRecognizeHandler),
...
# Receive local audio file name and Return Text
class LocalAudioRecognizeHandler(tornado.web.RequestHandler):
    ...
    # @tornado.gen.coroutine
    def post(self, *args, **kwargs):
        audio_path = tornado.web.RequestHandler.get_body_argument(self, "audio_path")
